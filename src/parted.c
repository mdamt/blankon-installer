...
static void device_init (Device* self) {
	...
	if (_tmp7_ != NULL) {
		...
		while (TRUE) {
			...
			PedPartitionType _tmp35_ = 0;
			DevicePartition* new_p = NULL;
			DevicePartition* _tmp38_ = NULL;
			DevicePartition* _tmp39_ = NULL;
			PedPartition* _tmp40_ = NULL;
			gint _tmp41_ = 0;
			DevicePartition* _tmp42_ = NULL;
			PedPartition* _tmp43_ = NULL;
			PedGeometry _tmp44_ = {0};
			guint64 _tmp45_ = 0ULL;
			guint64 _tmp46_ = 0ULL;
			DevicePartition* _tmp47_ = NULL;
			PedPartition* _tmp48_ = NULL;
			PedGeometry _tmp49_ = {0};
			guint64 _tmp50_ = 0ULL;
			guint64 _tmp51_ = 0ULL;
			DevicePartition* _tmp52_ = NULL;
			PedPartition* _tmp53_ = NULL;
			PedGeometry _tmp54_ = {0};
			guint64 _tmp55_ = 0ULL;
			guint64 _tmp56_ = 0ULL;
			DevicePartition* _tmp57_ = NULL;
			const gchar* _tmp58_ = NULL;
			DevicePartition* _tmp59_ = NULL;
			const gchar* _tmp60_ = NULL;
			DevicePartition* _tmp61_ = NULL;
			const gchar* _tmp62_ = NULL;
			DevicePartition* _tmp63_ = NULL;
			DevicePartitionType _tmp64_ = 0;
			...
			if (_tmp24_ > 0) {
				...
				_tmp32_ = _tmp31_;
				_tmp33_ = os_prober_get_description (_tmp32_);
			...
			_tmp38_ = device_partition_new ();
			new_p = _tmp38_;
			_tmp39_ = new_p;
			_tmp40_ = p;
			_tmp41_ = _tmp40_->num;
			device_partition_set_number (_tmp39_, _tmp41_);
			_tmp42_ = new_p;
			_tmp43_ = p;
			_tmp44_ = _tmp43_->geom;
			_tmp45_ = _tmp44_.start;
			_tmp46_ = self->priv->unit_size;
			device_partition_set_start (_tmp42_, ((guint64) _tmp45_) * _tmp46_);
			_tmp47_ = new_p;
			_tmp48_ = p;
			_tmp49_ = _tmp48_->geom;
			_tmp50_ = _tmp49_.end;
			_tmp51_ = self->priv->unit_size;
			device_partition_set_end (_tmp47_, ((guint64) _tmp50_) * _tmp51_);
			_tmp52_ = new_p;
			_tmp53_ = p;
			_tmp54_ = _tmp53_->geom;
			_tmp55_ = _tmp54_.length;
			_tmp56_ = self->priv->unit_size;
			device_partition_set_size (_tmp52_, ((guint64) _tmp55_) * _tmp56_);
			_tmp57_ = new_p;
			_tmp58_ = fs;
			device_partition_set_filesystem (_tmp57_, _tmp58_);
			_tmp59_ = new_p;
			_tmp60_ = flag;
			device_partition_set_flag (_tmp59_, _tmp60_);
			_tmp61_ = new_p;
			_tmp62_ = description;
			device_partition_set_description (_tmp61_, _tmp62_);
			_tmp63_ = new_p;
			_tmp64_ = type;
			device_partition_set_ptype (_tmp63_, _tmp64_);
		...
		_tmp67_ = self->priv->_partitions;
		_tmp68_ = gee_abstract_collection_get_is_empty ((GeeAbstractCollection*) _tmp67_);
		_tmp69_ = _tmp68_;
		if (_tmp69_) {
			DevicePartition* new_p = NULL;
			guint64 _tmp70_ = 0ULL;
			DevicePartition* _tmp71_ = NULL;
			GeeArrayList* _tmp72_ = NULL;
			DevicePartition* _tmp73_ = NULL;
			_tmp70_ = device_get_size (self);
			_tmp71_ = device_partition_new_blank_with_size (_tmp70_ - 1);
			new_p = _tmp71_;
			_tmp72_ = self->priv->_partitions;
			_tmp73_ = new_p;
		...
		DevicePartition* _tmp75_ = NULL;
		GeeArrayList* _tmp76_ = NULL;
		DevicePartition* _tmp77_ = NULL;
		_tmp74_ = device_get_size (self);
		_tmp75_ = device_partition_new_blank_with_size (_tmp74_ - 1);
		new_p = _tmp75_;
		_tmp76_ = self->priv->_partitions;
		_tmp77_ = new_p;
...
gint device_get_num_partitions (Device* self) {
	...
	_tmp2_ = ped_disk_get_last_partition_num (_tmp1_);
	result = _tmp2_;
	return result;
}
...
"TENDED nor a FREE partition. %d\n", (gint) _tmp46_);
	...
	if (_tmp75_) {
		...
		PedDisk* _tmp121_ = NULL;
		PedFileSystemType* _tmp122_ = NULL;
		guint64 _tmp123_ = 0ULL;
		guint64 _tmp124_ = 0ULL;
		PedPartition* _tmp125_ = NULL;
		...
		if (_tmp76_) {
			...
			gint _tmp88_ = 0;
			PedDisk* _tmp89_ = NULL;
			PedPartition* _tmp90_ = NULL;
			PedDevice* _tmp91_ = NULL;
			PedConstraint* _tmp92_ = NULL;
			PedConstraint* _tmp93_ = NULL;
			PedDisk* _tmp94_ = NULL;
			PedPartition* _tmp95_ = NULL;
			_tmp77_ = stdout;
			...
			_g_free0 (_tmp86_);
			_tmp89_ = self->priv->disk;
			_tmp90_ = ext;
			_tmp91_ = self->priv->device;
			_tmp92_ = ped_constraint_any (_tmp91_);
			_tmp93_ = _tmp92_;
			ped_disk_add_partition (_tmp89_, _tmp90_, _tmp93_);
			_ped_constraint_destroy0 (_tmp93_);
			_tmp94_ = self->priv->disk;
			ped_disk_commit_to_dev (_tmp94_);
			_tmp95_ = ext;
			if (_tmp95_ == NULL) {
				GError* _tmp96_ = NULL;
				_tmp96_ = g_error_new_literal (DEVICE_ERROR, DEVICE_ERROR_CANT_CREATE_PARTITION, "Can't create extended partition\n");
		...
		_tmp97_ = swap_size;
		if (_tmp97_ > ((guint64) 0)) {
			guint64 swap_size_sector = 0ULL;
			guint64 _tmp98_ = 0ULL;
			guint64 _tmp99_ = 0ULL;
			guint64 _tmp100_ = 0ULL;
			guint64 _tmp101_ = 0ULL;
			PedFileSystemType* swap_type = NULL;
			PedFileSystemType* _tmp102_ = NULL;
			PedDisk* _tmp103_ = NULL;
			PedFileSystemType* _tmp104_ = NULL;
			guint64 _tmp105_ = 0ULL;
			guint64 _tmp106_ = 0ULL;
			PedPartition* _tmp107_ = NULL;
			guint64 _tmp108_ = 0ULL;
			guint64 _tmp109_ = 0ULL;
			guint64 _tmp110_ = 0ULL;
			guint64 _tmp111_ = 0ULL;
			gint part_num = 0;
			PedDisk* _tmp112_ = NULL;
			PedPartition* _tmp113_ = NULL;
			PedDevice* _tmp114_ = NULL;
			PedConstraint* _tmp115_ = NULL;
			PedConstraint* _tmp116_ = NULL;
			gint _tmp117_ = 0;
			gint _tmp118_ = 0;
			gint _tmp119_ = 0;
			_tmp98_ = swap_size;
			_tmp99_ = device_get_unit_size (self);
			swap_size_sector = (guint64) (_tmp98_ / _tmp99_);
			_tmp100_ = start;
			_tmp101_ = swap_size_sector;
			end = _tmp100_ + _tmp101_;
			_tmp102_ = ped_file_system_type_get ("linux-swap(v1)");
			swap_type = _tmp102_;
			_tmp103_ = self->priv->disk;
			_tmp104_ = swap_type;
			_tmp105_ = start;
			_tmp106_ = end;
			_tmp107_ = ped_partition_new (_tmp103_, PED_PARTITION_LOGICAL, _tmp104_, _tmp105_, _tmp106_);
			new_partition = _tmp107_;
			_tmp108_ = end;
			_tmp109_ = swap_size_sector;
			start = (_tmp108_ + _tmp109_) + 1;
			_tmp110_ = byte_end;
			_tmp111_ = device_get_unit_size (self);
			end = (guint64) (_tmp110_ / _tmp111_);
			_tmp112_ = self->priv->disk;
			_tmp113_ = new_partition;
			_tmp114_ = self->priv->device;
			_tmp115_ = ped_constraint_any (_tmp114_);
			_tmp116_ = _tmp115_;
			_tmp117_ = ped_disk_add_partition (_tmp112_, _tmp113_, _tmp116_);
			_tmp118_ = _tmp117_;
			_ped_constraint_destroy0 (_tmp116_);
			part_num = _tmp118_;
			_tmp119_ = part_num;
			if (_tmp119_ == 0) {
				GError* _tmp120_ = NULL;
				_tmp120_ = g_error_new_literal (DEVICE_ERROR, DEVICE_ERROR_CANT_CREATE_PARTITION, "Unable to create swap\n");
		...
		_tmp121_ = self->priv->disk;
		_tmp122_ = fs_type;
		_tmp123_ = start;
		_tmp124_ = end;
		_tmp125_ = ped_partition_new (_tmp121_, PED_PARTITION_LOGICAL, _tmp122_, _tmp123_, _tmp124_);
		new_partition = _tmp125_;
	} else {
		PedDisk* _tmp126_ = NULL;
		PedFileSystemType* _tmp127_ = NULL;
		guint64 _tmp128_ = 0ULL;
		guint64 _tmp129_ = 0ULL;
		PedPartition* _tmp130_ = NULL;
		_tmp126_ = self->priv->disk;
		_tmp127_ = fs_type;
		_tmp128_ = start;
		_tmp129_ = end;
		_tmp130_ = ped_partition_new (_tmp126_, PED_PARTITION_NORMAL, _tmp127_, _tmp128_, _tmp129_);
		new_partition = _tmp130_;
	}
	_tmp131_ = new_partition;
	if (_tmp131_ != NULL) {
		gint part_num = 0;
		PedDisk* _tmp132_ = NULL;
		PedPartition* _tmp133_ = NULL;
		PedDevice* _tmp134_ = NULL;
		PedConstraint* _tmp135_ = NULL;
		PedConstraint* _tmp136_ = NULL;
		gint _tmp137_ = 0;
		gint _tmp138_ = 0;
		gint _tmp139_ = 0;
		PedPartition* _tmp141_ = NULL;
		PedGeometry _tmp142_ = {0};
		PedFileSystemType* _tmp143_ = NULL;
		PedFileSystem* _tmp144_ = NULL;
		PedDisk* _tmp145_ = NULL;
		PedDisk* _tmp146_ = NULL;
		PedPartition* _tmp147_ = NULL;
		gint _tmp148_ = 0;
		_tmp132_ = self->priv->disk;
		_tmp133_ = new_partition;
		_tmp134_ = self->priv->device;
		_tmp135_ = ped_constraint_any (_tmp134_);
		_tmp136_ = _tmp135_;
		_tmp137_ = ped_disk_add_partition (_tmp132_, _tmp133_, _tmp136_);
		_tmp138_ = _tmp137_;
		_ped_constraint_destroy0 (_tmp136_);
		part_num = _tmp138_;
		_tmp139_ = part_num;
		if (_tmp139_ == 0) {
			GError* _tmp140_ = NULL;
			_tmp140_ = g_error_new_literal (DEVICE_ERROR, DEVICE_ERROR_CANT_CREATE_PARTITION, "Unable to create partition\n");
		...
		_tmp141_ = new_partition;
		_tmp142_ = _tmp141_->geom;
		_tmp143_ = fs_type;
		_tmp144_ = ped_file_system_create (&_tmp142_, _tmp143_, NULL);
		_tmp145_ = self->priv->disk;
		ped_disk_commit_to_dev (_tmp145_);
		_tmp146_ = self->priv->disk;
		ped_disk_commit_to_os (_tmp146_);
		_tmp147_ = new_partition;
		_tmp148_ = _tmp147_->num;
		result = _tmp148_;
		return result;
	} else {
		GError* _tmp149_ = NULL;
		_tmp149_ = g_error_new_literal (DEVICE_ERROR, DEVICE_ERROR_CANT_CREATE_PARTITION, "Unable to create partition\n");
